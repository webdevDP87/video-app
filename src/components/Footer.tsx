export const Footer: React.FC = () => {
    ...
    return (
        <>
            <footer className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 mb-10 mt-20">
                <div className="max-w-5xl mx-auto">
                    <div className="flex flex-col gap-y-6 items-start">
                                    ...
                                    <ul className="flex flex-wrap items-center gap-x-8">
                                        {
                                            socialItems.map((socialItem, index) => {
                                                return (
                                                    <li key={index}>
                                                        <a className="text-white" href={socialItem.url} target="_blank" rel="noopener noreferrer" dangerouslySetInnerHTML={{ __html: socialItem.icon }}></a>
                                                    </li>
                                                )
                                            })
                                        }
                        ...
                        }
                        {
                            footerItems.length > 0 && (
                                <div className="w-full text-[0.8125rem]">
                                    <ul className="grid grid-cols-2 md:grid-cols-4 gap-y-1">
                                    {
                                        footerItems.map((footerItem, index) => {
                                            return (
                                                <li key={index}>
                                                    <span className="hover:underline inline-block text-neutral-400 py-1 cursor-pointer">{footerItem}</span>
                                                </li>
                                            )
                                        })
                                    }
                        ...
                        <a className="text-xs px-4 py-2 border border-neutral-500 text-neutral-400 hover:text-white leading-tight" href="#">Service code</a>
                        <span className="text-xs text-neutral-400">© 1997–2023 Netflix, Inc.</span>
                    </div>
